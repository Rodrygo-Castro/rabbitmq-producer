...
public class PacienteController {
    ...
    public String savePaciente(@Valid @ModelAttribute("pacienteModel") PacienteModel pacienteModel,
        ...
        if (pacienteModel.getId() != null) {
            ...
            savedPaciente = pacienteService.saveOrUpdate(pacienteModel);
    ...
    public ModelAndView editPaciente(@PathVariable("id") Long id, ModelMap model) {
        PacienteModel editpaciente = pacienteService.findByid(id);
        if (editpaciente == null) {
            model.addAttribute("pacienteModel", "editPaciente");
